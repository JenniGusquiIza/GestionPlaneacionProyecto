...
public class TrabajadorFragment extends Fragment {
    ...
    //Fragmento
    @Nullable @BindView(R.id.recyclerTrabajador) RecyclerView personaRecycler;
    private SwipeRefreshLayout refresh;
    private TrabajadorAdapter personaAdapter;

    //Layout dialog_persona
    @Nullable @BindView(R.id.llValidacion) LinearLayout llValidacion;
    ...
    @Nullable @BindView(R.id.rbGroupEstado)
    RadioGroup rbGroupEstado;
    @Nullable @BindView(R.id.bnGuardar)
    Button bnGuardar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_trabajador, container, false);
        unbinder= ButterKnife.bind(this, root);
        service= new PersonaService();
        personaAdapter= new TrabajadorAdapter(this,personaList);
        ...
        refresh=(SwipeRefreshLayout) root.findViewById(R.id.rlTrabajador);
    ...
    private boolean validateText(@NonNull String apellidos, String nombres, String fechaNac, String correo, String cedula,String telefono){
        ...
        if(cedula.isEmpty()){
            ...
            if(lenght==10){
                ...
                if(!validate.isEmpty()){
                    txtCorreo.setError("ruc inválida");
                    isCedula=false;
                }
            }else{
    ...
    public void editar(Persona persona){
        try{
            service.save(persona);
            Utils.messageConfirmation(getContext(),"Trabajador, guardado con éxito");
        }catch (Exception ex){
    ...
    public void eliminar(Persona persona){
        try{
            ...
            Utils.messageConfirmation(getContext(),"Trabajador, eliminado con éxito");
        }catch (Exception ex){
            Utils.messageError(getContext(),"Error ["+ex.getMessage()+"]");
        }
    }
